export default function Projects() {
  const webProjects = [
    ...
    { name: 'Personal Website', 
      ...
      link: 'In development' , 
      address: "", 
      image: "./src/components/images/personal.png",
      videoAddress: "", 
      videoLink: "In development" },
    ...
    { name: 'Desk help webservice prototype', 
      ...
      image: "./src/components/images/support.png", 
    ...
    { name: 'UWB Tracker', 
      ...
      image: "./src/components/images/uwb.png", 
      },
    { name: 'Spare Parts Controller', 
      ...
      image: "./src/components/images/voi.png", 
    ...
    { name: 'Flutter APP', 
      ...
      image: "./src/components/images/us.png", 
    },
    { name: 'KOTLIN APP', 
      ...
      image: "./src/components/images/su2.png", 
    ...
    { name: 'Express Food', 
      ...
      image: "./src/components/images/food.png", 
    },
    { name: 'Stonks', 
    ...
    { name: 'Boots shop', 
      ...
      image: "./src/components/images/boot.png", 
  ...
  const gameProjects = [
    { name: 'Multiplayer game prototype', 
      ...
      link: 'In development' , 
      address: "", 
      image: "./src/components/images/multiplayer.png",
      videoAddress: "", 
      videoLink: "In development" },
    { name: 'VR Shooter', 
      ...
      image: "./src/components/images/vr-shooter.png" },
    { name: 'Pass the Gas', 
      ...
      image: "./src/components/images/passthegas.png" },
    { name: 'Tom´s venture', 
      ...
      image: "./src/components/images/asteroid.png", 
    ...
    { name: 'Retro Tank Shooter', 
      ...
      image: "./src/components/images/tank.png" },
    { name: 'Frogger Clone', 
      ...
      image: "./src/components/images/frogger.png" },
    { name: 'Alien Invaders Remake', description: 'Unity Arcade Game', purpose: 'Fellowship of the Game extension group', kind: 'Individual Project', role: 'All', link: 'Play' , address: "https://stradioto.itch.io/te", image: "./src/components/images/alien.png" },
    { name: 'PLATA!TA!TA! FORMA', description: 'Unity Platform Game', purpose: 'Fellowship of the Game extension group', kind: 'Group Project', role: 'Collaborator (Programmer/UI)', link: 'Play' , address: "https://fog-icmc.itch.io/platatataforma", image: "./src/components/images/platatata.png" },
    { name: 'MineField Walker Game', description: 'JavaScript CLI Game', purpose: 'Introduction to Programming discipline at OAMK', kind: 'Individual Project', role: 'All', link: 'Github' , address: "https://github.com/Stradioto/OAMK-Information-Technology-Engineering/blob/main/Introduction%20to%20Programming%20and%20Software%20Development/MineFieldWalker.js", image: "./src/components/images/minefield.png" },
    { name: 'Scout Boy – Prototype', 
      ...
      image: "./src/components/images/plaform2d.png", 
    ...
    { name: 'Scout Boy – Concept', 
      ...
      image: "./src/components/images/platform2dimg.png", 
